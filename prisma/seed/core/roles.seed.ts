...
const ROLES = [
  ...
  },
  {
    ...
    permissions: ['users:*', 'orders:*', 'reports:*', 'vendors:*', 'production.queue:*', 'production.qc:*', 'production.control:*', 'production.machine:*'],
    isSystem: true,
  },
  {
    ...
    permissions: ['orders:*', 'workflow:*', 'reports:read', 'vendors:*', 'production.queue:*', 'production.task.assign', 'production.task.view.all', 'production.task.execute', 'production.qc:*', 'production.control:*', 'production.machine:*'],
    isSystem: true,
  },
  {
    name: RoleName.STAFF,
